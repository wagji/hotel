...
<body>
	...
	<h1>새 글 등록</h1>
	<form method="post" action="insertHotels.Hotels">
		<table border="1" cellpadding="10" cellspacing="0">

			<tr>
				<td bgcolor="orange" align="center">HotelsNumber</td>
				<td><input type="text" name="HotelsNumber"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">HotelsName</td>
				<td><input type="text" name="HotelsName" size="10"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">HotelsAddress</td>
				<td><textarea name="HotelsAddress" rows="10" cols="40"></textarea></td>
			</tr>
