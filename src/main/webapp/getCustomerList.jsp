...
try {
	CustomerList = (List<CustomerDTO>) session.getAttribute("CustomerList");
%>
...
<body>
	...
	<table border="1" width="700px">
		<tr>
			...
			<th bgcolor="orange" width="100px">CustomerName</th>
			<th bgcolor="orange" width="100px">PhoneNumber</th>
			<th bgcolor="orange" width="100px">ResidentRegistrationNumber</th>
			<th bgcolor="orange" width="100px">Email</th>
			<th bgcolor="orange" width="100px">Password</th>
			<th bgcolor="orange" width="100px">Address</th>
		</tr>
		<%
		for (CustomerDTO k : CustomerList) {
		%>

		<tr>
			<td><a
				href="getCustomer.customer?CustomerNumber=<%=k.getCustomerNumber()%>">
					<%=k.getCustomerNumber()%></a></td>
			<td><%=k.getCustomerName()%></td>
			<td><%=k.getPhoneNumber()%></td>
			<td><%=k.getResidentRegistrationNumber()%></td>
			<td><%=k.getEmail()%></td>
			<td><%=k.getPassword()%></td>
			<td><%=k.getAddress()%></td>
		</tr>
	...
	<p />
	<a href="insertCustomer.jsp"> 새 맴버 등록</a>
	<p />
	<a href="deleteCustomer.jsp"> 맴버삭제</a>
