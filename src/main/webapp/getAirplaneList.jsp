...
try {
	AirplaneList = (List<AirplaneDTO>) session.getAttribute("AirplaneList");
%>
...
<body>
	...
	<table border="1" width="700px">
		<tr>
			...
			<th bgcolor="orange" width="100px">AirplaneName</th>
			<th bgcolor="orange" width="100px">Capacity</th>
			<th bgcolor="orange" width="100px">DepartureCity</th>
			<th bgcolor="orange" width="100px">DestinationCity</th>
		</tr>
		<%
		for (AirplaneDTO k : AirplaneList) {
		%>

		<tr>
			<td align="center"><a
				href="getAirplane.Airplane?SerialNumber=<%=k.getSerialNumber()%>"
				style="color: white"> <%=k.getSerialNumber()%>
			</a></td>
			<td><%=k.getAirplaneName()%></td>
			<td><%=k.getCapacity()%></td>
			<td><%=k.getDepartureCity()%></td>
			<td><%=k.getDestinationCity()%></td>
		</tr>
		<%
		}
		session.removeAttribute("AirplaneList");
		}
	...
	<p />
	<a href="insertAirplane.jsp" style="color: white"> 새 글쓰기</a>
	<p />
	<a href="deleteAirplane.jsp" style="color: white"> 글 삭제</a>
