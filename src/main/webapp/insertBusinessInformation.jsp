...
<h1>새 글 등록</h1>
<form method = "post" action = "insertBusinessInformation.Business">
...
<tr>
 ...
 <td> <input type="text" name = "BusinessAddress" size="10"></td>
</tr>

<tr>
 <td  bgcolor="orange" align = "center"> RoomType </td> 
 <td> <textarea name="RoomType" rows="10" cols="40"></textarea></td>
 </tr>
 
 <tr>
 <td  bgcolor="orange" align = "center"> RoomCount </td> 
 <td> <textarea name="RoomCount" rows="10" cols="40"></textarea></td>
 </tr>
 
 <tr>
 <td  bgcolor="orange" align = "center"> Fee </td> 
 <td> <textarea name="Fee" rows="10" cols="40"></textarea></td>
 </tr>
...
<p /> <a href= "getBusinessInformationList.Business"> 글 목록 </a>
