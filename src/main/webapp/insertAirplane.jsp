...
<body>
	...
	<h1>새 Airplane 등록</h1>
	<form method="post" action="insertAirplane.Airplane">
		<table border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				...
				<td><input type="text" name="AirplaneName" size="10"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">Capacity</td>
				<td><textarea name="Capacity" rows="10" cols="40"></textarea></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">DepartureCity</td>
				<td><textarea name="DepartureCity" rows="10" cols="40"></textarea></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">DestinationCity</td>
				<td><textarea name="DestinationCity" rows="10" cols="40"></textarea></td>
			</tr>
	...
	<p />
	<a href="getAirplaneList.Airplane"> 글 목록 </a>
