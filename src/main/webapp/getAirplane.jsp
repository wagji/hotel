<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="Airplane.AirplaneDTO"%>

<%
AirplaneDTO Airplane = new AirplaneDTO();
Airplane = (AirplaneDTO) session.getAttribute("Airplane");
%>
...
<body>
	...
	<br>
	<br>
	<form method="post" action="updateAirplane.Airplane">

		<input type="hidden" name="SerialNumber"
			value="<%=Airplane.getSerialNumber()%>">
		<table border="1" width="700px" cellpadding="5px">

			<tr>
				<td bgcolor="orange" align="center">AirplaneName</td>
				<td><input type="text" name="AirplaneName"
					value="<%=Airplane.getAirplaneName()%>"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">Capacity</td>
				<td><input type="text" name="Capacity"
					value="<%=Airplane.getCapacity()%>"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">DepartureCity</td>
				<td><textarea name="DepartureCity" rows="10" cols="70"> <%=Airplane.getDepartureCity()%> </textarea></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">DestinationCity</td>
				<td><textarea name="Fee" rows="10" cols="70"> <%=Airplane.getDestinationCity()%> </textarea></td>
			</tr>
	...
	<br>
	<a
		href="deleteAirplane.Airplane?SerialNumber=<%=Airplane.getSerialNumber()%>">
		글 삭제</a>

	<p />
	<a href="http://localhost:8081/HOTEL"> 홈으로 </a>
	<p />
	<a href="getAirplaneList.jsp"> 글 목록</a>
	<p />
	<a href="insertAirplane.jsp"> 새 글쓰기</a>
	<p />
	<a href="deleteAirplane.jsp"> 글삭제</a>
