...
<body>
	<header>
		...
		<ul class="menu">
			...
			<li><a href="#">login</a>
				<ul class="submenu">
					<li><a href="Login.jsp">로그인 페이지</a>
					<li><a href="getHotelsList.jsp"> Hotels 정보 리스트</a>
					<li><a href="deleteBusinessInformation.jsp"> 사업자 정보 삭제</a>
						<p /></li>
			...
			<li><a href="#">get</a>
				<ul class="submenu">
					...
					<li><a href="insertBusinessInformation.jsp"> 사업자 정보 등록</a>
						<p /></li>
					<li><a href="getBusinessInformationList.jsp"> 사업자 정보 리스트</a>
						<p /></li>
					<li><a href="#">submenu05</a></li>
				</ul></li>
			<li><a href="#">delete</a>
				<ul class="submenu">
					...
					<li><a href="deleteReservationHistory.jsp"> Reservation 정보
							삭제</a>
					<li><a href="deleteHotels.jsp"> Hotels 정보 삭제</a>
						<p /></li>
	...
	<h1>글 삭제</h1>
	<form method="post" action="deleteHotels.Hotels">
		<tr>
			<td>삭제할 게시글 HotelsNumber 입력 :</td>
			<td><input type="text" name="HotelsNumber"></td>
		<tr>
	...
	<p />
	<a href="getHotelsList.Hotels"> 글 목록 </a>
