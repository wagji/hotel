...
<body>
	...
	<h1>새 글 등록</h1>
	<form method="post" action="insertReservationHistory.Reservation">
		<table border="1" cellpadding="10" cellspacing="0">
			...
			<tr>
				...
				<td><input type="text" name="NumberOfPeople" size="10"></td>
			</tr>
	...
	<p />
	<a href="getReservationHistoryList.Reservation"> 글 목록 </a>
