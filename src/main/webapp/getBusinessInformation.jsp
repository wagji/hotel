...
BusinessInformation = (BusinessInformationDTO) session.getAttribute("BusinessInformation");
%>
...
<body>
	...
	<br>
	<br>
	<form method="post" action="updateBusinessInformation.Business">

		<input type="hidden" name="SerialNumber"
			value="<%=BusinessInformation.getSerialNumber()%>">
		<table border="1" width="700px" cellpadding="5px">

			<tr>
				<td bgcolor="orange" align="center">BusinessAddress</td>
				<td><input type="text" name="BusinessAddress"
					value="<%=BusinessInformation.getBusinessAddress()%>"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">RoomType</td>
				<td><input type="text" name="RoomType"
					value="<%=BusinessInformation.getRoomType()%>"></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">RoomCount</td>
				<td><textarea name="RoomCount" rows="10" cols="70"> <%=BusinessInformation.getRoomCount()%> </textarea></td>
			</tr>

			<tr>
				<td bgcolor="orange" align="center">Fee</td>
				<td><textarea name="Fee" rows="10" cols="70"> <%=BusinessInformation.getFee()%> </textarea></td>
			</tr>
	...
	<br>
	<a
		href="deleteBusinessInformation.Business?SerialNumber=<%=BusinessInformation.getSerialNumber()%>">
		글 삭제</a>

	<p />
	<a href="http://localhost:8081/HOTEL"> 홈으로 </a>
	<p />
	<a href="getBusinessInformationList.jsp"> 글 목록</a>
	<p />
	<a href="insertBusinessInformation.jsp"> 새 글쓰기</a>
	<p />
	<a href="deleteBusinessInformation.jsp"> 글삭제</a>
