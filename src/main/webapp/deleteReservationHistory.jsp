...
<h1>글 삭제</h1>
<form method = "post" action ="deleteReservationHistory.Reservation"> 
<tr> <td> 삭제할 게시글 ReservationNumber 입력 :  </td> 
...
<p /> <a href= "getReservationHistoryList.Reservation"> 글 목록 </a>
